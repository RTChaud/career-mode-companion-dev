...
const Lineups = (() => {
  const FORMATIONS = {
    '4-3-3-attack': {
      ...
      label: '4-3-3 Attack',
      slots: [
        { key: 'GK',  position: 'GK',  label: 'GK',  role: 'Sweeper Keeper',        focus: 'Build Up', x: 50, y: 91 },
        { key: 'RB',  position: 'RB',  label: 'RB',  role: 'Fullback',              focus: 'Balanced', x: 83, y: 62 },
        { key: 'RCB', position: 'CB',  label: 'RCB', role: 'Ball-Playing Defender', focus: 'Defend',   x: 61, y: 68 },
        { key: 'LCB', position: 'CB',  label: 'LCB', role: 'Defender',              focus: 'Defend',   x: 39, y: 68 },
        { key: 'LB',  position: 'LB',  label: 'LB',  role: 'Fullback',              focus: 'Balanced', x: 17, y: 62 },
        { key: 'RCM', position: 'CM',  label: 'RCM', role: 'Holding Midfielder',    focus: 'Defend',   x: 67, y: 44 },
        { key: 'LCM', position: 'CM',  label: 'LCM', role: 'Box-to-Box',            focus: 'Balanced', x: 33, y: 44 },
        { key: 'CAM', position: 'CAM', label: 'CAM', role: 'Shadow Striker',        focus: 'Attack',   x: 50, y: 29 },
        { key: 'RW',  position: 'RW',  label: 'RW',  role: 'Inside Forward',        focus: 'Attack',   x: 81, y: 13 },
        { key: 'ST',  position: 'ST',  label: 'ST',  role: 'Advanced Forward',      focus: 'Attack',   x: 50, y: 8  },
        { key: 'LW',  position: 'LW',  label: 'LW',  role: 'Inside Forward',        focus: 'Attack',   x: 19, y: 13 },
      ],
    },
  };
